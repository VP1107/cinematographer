...
import { Instagram, Youtube, Linkedin, Film, Facebook, Send } from 'lucide-react';
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (GOOGLE_SCRIPT_URL !== 'YOUR_GOOGLE_APPS_SCRIPT_WEB_APP_URL') {
      try {
        // Send a simple POST request (text/plain) to avoid CORS preflight (OPTIONS) pre-check errors.
        // Google Apps Script will parse this JSON payload in its doPost(e) handler.
      ...
      // Default mailto fallback if script URL is not configured
      window.location.href = `mailto:${contactInfo.email}?subject=${encodeURIComponent(form.subject || 'Project Enquiry')}&body=${encodeURIComponent(`Name: ${form.name}\n\n${form.message}`)}`;
    }
